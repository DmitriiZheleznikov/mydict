package md.textanalysis.text.analyse.word;

import md.textanalysis.callback.IProgressFunction;
import md.textanalysis.ctrl.AContext;
import md.textanalysis.text.analyse.word.impl.IrregularVerbsAnalyser;
import md.textanalysis.text.analyse.word.impl.RootFinderAnalyser;
import md.textanalysis.text.analyse.word.impl.SpecialCasesAnalyser;
